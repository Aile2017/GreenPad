...
ROPT = $(DEF) /L 0x411 /c 65001 /I "GreenStar\rsrc"

$(TARGET): PRE $(OBJS) $(RES)
	link $(LOPT) /OUT:$(TARGET) $(OBJS) $(RES) $(LIBS)

$(RES): GreenStar\rsrc\gs_rsrc.rc GreenStar\rsrc\resource.h GreenStar\rsrc\greenstar.ico
	rc $(ROPT) /Fo$@ GreenStar\rsrc\gs_rsrc.rc

# Shared source files compiled from project root (kilib, editwing, top-level)
{.}.cpp{$(INTDIR)}.obj:
	cl $(COPT) /Fo$@ $**
...
# GreenStar-specific sources: /I "." exposes kilib/editwing from root,
# /I "GreenStar" exposes GreenStar/rsrc/resource.h as "rsrc/resource.h"
{GreenStar}.cpp{$(INTDIR)}.obj:
	cl $(COPT) /I "." /I "GreenStar" /Fo$@ $**
