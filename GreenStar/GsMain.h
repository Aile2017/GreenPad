#ifndef _GREENSTAR_MAIN_H_
#define _GREENSTAR_MAIN_H_
...
class GsStBar A_FINAL: public ki::StatusBar
{
public:
...
//=========================================================================
//@{
//	main window (WordStar key bindings)
//@}
//=========================================================================

class GreenStarWnd A_FINAL
	: public ki::WndImpl
...
private:
	...
	// WordStar two-stroke key state: 0=normal, 'K'=after Ctrl+K, 'Q'=after Ctrl+Q
	int              wsKeyState_;
...
private:
	...
	// WordStar key handler: returns true if the key was consumed
	bool    HandleWsKey( MSG* msg );
};
